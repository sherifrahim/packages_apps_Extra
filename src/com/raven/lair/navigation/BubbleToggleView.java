        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_corvus_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_corvus_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_corvus_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_corvus_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_corvus_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_corvus_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_corvus_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_corvus_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_corvus_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_corvus_colorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_corvus_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_corvus_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_corvus_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_corvus_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_corvus_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
